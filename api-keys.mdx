...
Your API keys should be confidential. Do not upload your API keys to public storage, Github or client code. If you suspect your API keys have been compromised, you can delete the API key in your dashboard.
